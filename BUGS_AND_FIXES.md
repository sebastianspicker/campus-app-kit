...
**Status: Fixed.** Rate limiting now runs first (after URL + CORS); OPTIONS and all requests are rate-limited. Client key validates forwarded IPs (ù23).
...
| Rate limit too strict or bypassed | trustProxy / forwarded headers / OPTIONS | ?22ùùù25; document proxy setup |

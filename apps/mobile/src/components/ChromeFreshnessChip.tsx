/** Quiet Chronograph freshness pill for header chrome (success wash + status dot). */
...
/** Renders the header freshness chip when chrome status is non-null; otherwise nothing. */

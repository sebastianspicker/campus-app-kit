/** Horizontal primary destinations for Quiet Chronograph chrome. */
...
/** True when pathname belongs to the given destination (Today also owns schedule detail). */
...
export type SignalNavProps = {
  /** Desktop centers/right-aligns; compact stays full-width scroll. */
  desktop?: boolean;
  wideNavigation?: boolean;
};

/** Renders scrollable primary nav with soft 2px accent underline on the active item. */

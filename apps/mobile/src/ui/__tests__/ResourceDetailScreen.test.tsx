...
vi.mock("../ThemeContext", () => ({ useTheme: () => ({ colors: { text: "#17202A", muted: "#5C6873", border: "#D7DEE3", surface: "#fff" } }) }));
vi.mock("../Screen", () => ({ Screen: ({ children }: { children: React.ReactNode }) => <main>{children}</main> }));
